...
const EMAIL = "info@mdroofinglandscaping.co.uk";

const field =
  "w-full border border-slate-200 bg-white px-4 py-3 text-slate-800 placeholder-slate-400 outline-none transition-colors focus:border-[#1a3a2a] focus:ring-2 focus:ring-[#3f8f47]/40";

const SERVICES = [
  "Roofing (Pitched / Flat)",
...
export function EnquiryForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3.5">
      ...
      <button
        type="submit"
        className="group flex w-full items-center justify-center gap-2 bg-[#1a3a2a] px-6 py-4 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-[#0a1610]"
      >
        Send enquiry
