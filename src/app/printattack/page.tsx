        ...
        <div className="mx-auto w-full max-w-6xl px-5 pb-16 pt-32 text-white md:px-8 md:pb-24">
          <div className="max-w-3xl">
            ...
            <div className="hero-fade mt-9 flex flex-wrap gap-4 opacity-0" style={{ transform: "translateY(8px)" }}>
              <Link href="/printattack/contact#quote" data-magnetic className={btnBlue}>Get a quote <Arrow /></Link>
              <Link href="/printattack/work" className={btnGhostDark}>See our work</Link>
            </div>
      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 md:grid-cols-2 md:px-8 md:py-24 lg:gap-16">
          <div data-reveal>
            ...
            <Link href="/printattack/about" className={`${btnGhostLight} mt-8`}>About us <Arrow /></Link>
          </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          <div className="flex flex-wrap items-end justify-between gap-4" data-reveal>
            ...
            <Link href="/printattack/products" className="text-sm font-bold uppercase tracking-wide text-[#0e0e10] underline-offset-4 hover:underline">See everything →</Link>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-5 pb-20 md:px-8" data-reveal>
          <div className="relative flex flex-col items-center justify-between gap-6 overflow-hidden bg-[#EC008C] px-7 py-12 text-center text-white md:flex-row md:px-12 md:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/printattack/contact#quote" data-magnetic className="rounded-md bg-white px-7 py-4 text-sm font-bold uppercase tracking-wide text-[#0e0e10] transition-transform hover:-translate-y-0.5">Get a quote</Link>
