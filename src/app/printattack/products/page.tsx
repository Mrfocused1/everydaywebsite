          ...
          <div className="relative grid items-center gap-8 overflow-hidden bg-[#EC008C] p-8 text-white md:grid-cols-[auto_1fr] md:p-12" data-reveal>
            ...
            <div>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link href="/printattack/contact#quote" className={btnBlue}>Get a quote <Arrow /></Link>
                <Link href="/printattack/work" className="inline-flex items-center justify-center gap-2 rounded-md border border-white/40 px-7 py-4 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:bg-white/10">Our work</Link>
              </div>
            </div>
          </div>
        </div>
