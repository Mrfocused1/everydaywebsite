...
export function EnquiryForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3.5">
      ...
      <button
        type="submit"
        className="group flex w-full items-center justify-center gap-2 bg-[#16225e] px-6 py-4 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-[#0f1845]"
      >
        Send enquiry
