  ...
  return (
    <>
      ...
      <section className="relative isolate flex min-h-[88vh] items-end overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 bg-gradient-to-t from-[#1a1815]/92 via-[#1a1815]/55 to-[#1a1815]/30" />
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-[#1a1815]/70 via-transparent to-transparent" />
        ...
        <div className="mx-auto w-full max-w-6xl px-5 pb-16 pt-32 text-white md:px-8 md:pb-24">
          <div className="max-w-3xl">
            ...
            <h1 className="hero-h mt-6 text-[3rem] font-bold uppercase leading-[0.9] tracking-tight md:text-[5rem]">
              ...
              <span className="block overflow-hidden"><span className="hero-line-inner block text-[#d9a888]" style={{ transform: "translateY(110%)" }}>finish.</span></span>
            </h1>
            ...
            <div className="hero-fade mt-10 flex flex-wrap gap-x-7 gap-y-2 border-t border-white/20 pt-6 text-xs font-semibold uppercase tracking-wider opacity-0">
              {["Sovereign Approved", "Parex Render", "Lime Specialist", "Free Quotes"].map((t) => (
                <span key={t} className="flex items-center gap-2 text-white/80"><span className="h-1.5 w-1.5 bg-[#b06a43]" aria-hidden /> {t}</span>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* ── Intro + trust badges ── */}
      <section className="border-b border-slate-100 bg-[#f5f1ec]" style={GRID_BG}>
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 md:grid-cols-2 md:px-8 md:py-24">
          ...
          <div className="grid grid-cols-2 border border-[#26231f]/15 bg-white" data-stagger>
            {ACCREDS.map((a) => (
              <div key={a} className="flex flex-col gap-3 border-b border-r border-[#26231f]/10 p-6 last:border-r-0 odd:border-r [&:nth-child(n+3)]:border-b-0 md:p-8">
      ...
      <section data-hscroll className="relative bg-[#26231f] text-white">
        <div data-hscroll-pin className="sticky top-0 flex h-screen items-center overflow-hidden">
          <div data-hscroll-track className="flex w-full gap-5 px-5 py-12 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:gap-7 md:px-[7vw] md:py-0">
            ...
            <p className="mt-6 flex items-center gap-2 text-sm font-semibold uppercase tracking-wide text-[#d9a888]">Scroll <Arrow /></p>
          </div>
          {HSCROLL.map((s, i) => (
            <article key={s.t} className="group relative flex w-[80%] shrink-0 snap-start flex-col justify-end overflow-hidden max-md:aspect-[3/4] md:h-[66vh] md:w-[27vw] lg:w-[23vw]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1a1815] via-[#1a1815]/45 to-[#1a1815]/10" />
              <span className="absolute left-5 top-4 text-5xl font-bold text-[#d9a888]">0{i + 1}</span>
      ...
      <section className="bg-white" style={GRID_BG}>
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-px border-x border-[#26231f]/10 bg-[#26231f]/10 md:grid-cols-4" data-stagger>
          {[
            ...
            <div key={st.l} className="bg-white p-7 text-center md:p-10">
              <p className="text-4xl font-bold tracking-tight text-[#26231f] md:text-5xl" data-count={st.v} data-suffix={st.s || ""}>0{st.s || ""}</p>
      ...
      <section className="bg-[#f5f1ec]">
        <div className="mx-auto max-w-6xl px-5 pt-16 md:px-8 md:pt-24">
          <svg viewBox="0 0 1200 50" className="h-8 w-full" fill="none" preserveAspectRatio="none" aria-hidden>
            <path className="draw-line" d="M0 25 H280 L312 6 H540 L572 44 H840 L872 25 H1200" stroke="#b06a43" strokeWidth="2.5" />
          </svg>
        </div>
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-10 md:grid-cols-2 md:px-8 md:pb-24 lg:gap-16">
          ...
          <div data-reveal>
            ...
            <ul className="mt-7 grid gap-x-6 gap-y-3 sm:grid-cols-2">
              {REASONS.map((r) => (
                <li key={r} className="flex items-start gap-3 text-sm font-medium text-[#26231f]">
                  <span className="mt-1 h-2.5 w-2.5 shrink-0 bg-[#b06a43]" aria-hidden /> {r}
                </li>
              ))}
            </ul>
          </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          <div className="grid items-center gap-8 border border-[#26231f]/15 bg-[#26231f] p-8 text-white md:grid-cols-[1.2fr_1fr] md:p-12" data-reveal>
            <div>
            ...
            <div className="grid grid-cols-2 gap-px bg-white/10" data-stagger>
              {["Sovereign Chemicals", "Parex Render", "British Gypsum", "K-Rend & Weber"].map((b) => (
                <div key={b} className="flex items-center gap-3 bg-[#26231f] p-5">
                  <span className="h-2 w-2 shrink-0 bg-[#d9a888]" aria-hidden />
      ...
      {/* ── CTA ── */}
      <section className="border-t border-slate-100 bg-[#f5f1ec]" style={GRID_BG}>
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-5 py-16 text-center md:flex-row md:px-8 md:text-left" data-reveal>
          <div>
            <h2 className="text-3xl font-bold uppercase tracking-tight text-[#26231f] md:text-4xl">Got a wall that needs sorting?</h2>
