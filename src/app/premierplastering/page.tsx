  ...
  return (
    <>
      ...
      <section className="relative isolate flex min-h-[88vh] items-end overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 bg-gradient-to-t from-[#0e1c2b]/92 via-[#0e1c2b]/55 to-[#0e1c2b]/30" />
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-[#0e1c2b]/70 via-transparent to-transparent" />
        ...
        <div className="mx-auto w-full max-w-6xl px-5 pb-16 pt-32 text-white md:px-8 md:pb-24">
          <div className="max-w-3xl">
            ...
            <h1 className="hero-h mt-6 text-[3rem] font-bold uppercase leading-[0.9] tracking-tight md:text-[5rem]">
              ...
              <span className="block overflow-hidden"><span className="hero-line-inner block text-[#9ec9ee]" style={{ transform: "translateY(110%)" }}>finish.</span></span>
            </h1>
      ...
      {/* ── Intro + trust badges ── */}
      <section className="border-b border-slate-100 bg-[#f1f5f9]" style={GRID_BG}>
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 md:grid-cols-2 md:px-8 md:py-24">
          ...
          <div className="grid grid-cols-2 border border-[#16293c]/15 bg-white" data-stagger>
            {ACCREDS.map((a) => (
              <div key={a} className="flex flex-col gap-3 border-b border-r border-[#16293c]/10 p-6 last:border-r-0 odd:border-r [&:nth-child(n+3)]:border-b-0 md:p-8">
                <span className="h-2.5 w-2.5 bg-[#ff5e3c]" aria-hidden />
                <p className="text-sm font-bold uppercase tracking-wide text-[#16293c]">{a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section data-hscroll className="relative bg-[#16293c] text-white">
        <div data-hscroll-pin className="sticky top-0 flex h-screen items-center overflow-hidden">
          <div data-hscroll-track className="flex w-full gap-5 px-5 py-12 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:gap-7 md:px-[7vw] md:py-0">
            ...
            <p className="mt-6 flex items-center gap-2 text-sm font-semibold uppercase tracking-wide text-[#9ec9ee]">Scroll <Arrow /></p>
          </div>
          {HSCROLL.map((s, i) => (
            <article key={s.t} className="group relative flex w-[80%] shrink-0 snap-start flex-col justify-end overflow-hidden max-md:aspect-[3/4] md:h-[66vh] md:w-[27vw] lg:w-[23vw]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0e1c2b] via-[#0e1c2b]/45 to-[#0e1c2b]/10" />
              <span className="absolute left-5 top-4 text-5xl font-bold text-[#9ec9ee]">0{i + 1}</span>
      ...
      <section className="bg-white" style={GRID_BG}>
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-px border-x border-[#16293c]/10 bg-[#16293c]/10 md:grid-cols-4" data-stagger>
          {[
            ...
            <div key={st.l} className="bg-white p-7 text-center md:p-10">
              <p className="text-4xl font-bold tracking-tight text-[#16293c] md:text-5xl" data-count={st.v} data-suffix={st.s || ""}>0{st.s || ""}</p>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 pt-10 md:grid-cols-2 md:px-8 md:pb-24 lg:gap-16">
          ...
          <div data-reveal>
            ...
            <ul className="mt-7 grid gap-x-6 gap-y-3 sm:grid-cols-2">
              {REASONS.map((r) => (
                <li key={r} className="flex items-start gap-3 text-sm font-medium text-[#16293c]">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          <div className="grid items-center gap-8 border border-[#16293c]/15 bg-[#16293c] p-8 text-white md:grid-cols-[1.2fr_1fr] md:p-12" data-reveal>
            <div>
            ...
            <div className="grid grid-cols-2 gap-px bg-white/10" data-stagger>
              {["Sovereign Chemicals", "Parex Render", "British Gypsum", "K-Rend & Weber"].map((b) => (
                <div key={b} className="flex items-center gap-3 bg-[#16293c] p-5">
                  <span className="h-2 w-2 shrink-0 bg-[#9ec9ee]" aria-hidden />
      ...
      <section className="border-t border-slate-100 bg-[#f1f5f9]" style={GRID_BG}>
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-5 py-16 text-center md:flex-row md:px-8 md:text-left" data-reveal>
          <div>
            <h2 className="text-3xl font-bold uppercase tracking-tight text-[#16293c] md:text-4xl">Got a wall that needs sorting?</h2>
