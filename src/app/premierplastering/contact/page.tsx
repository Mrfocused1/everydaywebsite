      ...
      <section className="bg-white">
        <div className="mx-auto grid max-w-6xl gap-12 px-5 py-16 md:px-8 md:py-24 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div data-reveal>
            ...
            <div className="mt-9 border border-[#26231f]/15">
              <a href={PHONE_1_TEL} className="flex items-center gap-4 border-b border-[#26231f]/10 p-5 transition-colors hover:bg-[#f5f1ec]">
                <span className="grid h-11 w-11 shrink-0 place-items-center bg-[#b06a43] text-lg text-white" aria-hidden>☎</span>
                <span>
                  <span className="block text-[11px] font-semibold uppercase tracking-wider text-slate-400">Mobile</span>
                  <span className="block text-lg font-bold text-[#26231f]">{PHONE_1_DISPLAY}</span>
                </span>
              </a>
              <a href={PHONE_2_TEL} className="flex items-center gap-4 border-b border-[#26231f]/10 p-5 transition-colors hover:bg-[#f5f1ec]">
                <span className="grid h-11 w-11 shrink-0 place-items-center bg-[#b06a43] text-lg text-white" aria-hidden>☎</span>
                <span>
                  <span className="block text-[11px] font-semibold uppercase tracking-wider text-slate-400">Mobile</span>
                  <span className="block text-lg font-bold text-[#26231f]">{PHONE_2_DISPLAY}</span>
                </span>
              </a>
              <a href={PHONE_3_TEL} className="flex items-center gap-4 border-b border-[#26231f]/10 p-5 transition-colors hover:bg-[#f5f1ec]">
                <span className="grid h-11 w-11 shrink-0 place-items-center bg-[#b06a43] text-lg text-white" aria-hidden>☎</span>
                <span>
                  <span className="block text-[11px] font-semibold uppercase tracking-wider text-slate-400">Office</span>
                  <span className="block text-lg font-bold text-[#26231f]">{PHONE_3_DISPLAY}</span>
                </span>
              </a>
              <a href={`mailto:${EMAIL}`} className="flex items-center gap-4 border-b border-[#26231f]/10 p-5 transition-colors hover:bg-[#f5f1ec]">
                <span className="grid h-11 w-11 shrink-0 place-items-center bg-[#b06a43] text-lg text-white" aria-hidden>✉</span>
                <span>
                  <span className="block text-[11px] font-semibold uppercase tracking-wider text-slate-400">Email</span>
                  <span className="block break-all text-base font-bold text-[#26231f]">{EMAIL}</span>
                </span>
              </a>
              <div className="flex items-center gap-4 p-5">
                ...
                <span>
                  ...
                  <span className="block text-base font-bold text-[#26231f]">Ulverston, South Cumbria</span>
          ...
          {/* Form */}
          <div data-reveal>
            <div id="quote" className="scroll-mt-28 border border-[#26231f]/15 bg-[#f5f1ec] p-6 md:p-8">
              <h3 className="text-2xl font-bold uppercase tracking-tight text-[#26231f]">Request a quote</h3>
