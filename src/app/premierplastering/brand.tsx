...
export const GRID_BG: React.CSSProperties = {
  backgroundImage:
    "linear-gradient(rgba(38,35,31,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(38,35,31,0.05) 1px, transparent 1px)",
  backgroundSize: "46px 46px",
};

// ── Buttons (sharp; warm clay is the brand accent) ──
export const btnYellow =
  "group inline-flex items-center justify-center gap-2.5 bg-[#b06a43] px-7 py-4 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-[#9a5836]";
export const btnNavy =
  "group inline-flex items-center justify-center gap-2.5 bg-[#26231f] px-7 py-4 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-[#15120f]";
export const btnGhostDark =
  "group inline-flex items-center justify-center gap-2.5 border border-white/25 px-7 py-4 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:border-[#b06a43] hover:text-[#d9a888]";
export const btnGhostLight =
  "group inline-flex items-center justify-center gap-2.5 border border-[#26231f]/25 px-7 py-4 text-sm font-semibold uppercase tracking-wide text-[#26231f] transition-colors hover:bg-[#26231f] hover:text-white";
...
export function Label({ children, onDark = false }: { children: React.ReactNode; onDark?: boolean }) {
  return (
    <p className={`flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.28em] ${onDark ? "text-white/70" : "text-[#26231f]"}`}>
      <span className="h-2.5 w-2.5 bg-[#b06a43]" aria-hidden /> {children}
    </p>
  );
}
...
export function PageHero({ eyebrow, title, intro, img, imgAlt }: { eyebrow: string; title: string; intro: string; img: string; imgAlt: string }) {
  return (
    <section className="relative isolate flex min-h-[20rem] items-end overflow-hidden md:min-h-[27rem]">
      ...
      <div className="absolute inset-0 -z-10 bg-gradient-to-t from-[#1a1815]/92 via-[#1a1815]/55 to-[#1a1815]/25" />
      ...
      <div className="mx-auto w-full max-w-6xl px-5 pb-10 pt-28 text-white md:px-8 md:pb-14">
        <p className="hero-fade flex items-center gap-2.5 text-xs font-semibold uppercase tracking-[0.28em] text-white/70 opacity-0" style={{ transform: "translateY(8px)" }}>
          <span className="h-2.5 w-2.5 bg-[#b06a43]" aria-hidden /> {eyebrow}
        </p>
        ...
        <span className="mt-5 block h-1 w-16 bg-[#b06a43]" aria-hidden />
